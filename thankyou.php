...
<div class="container py-5">
        <div class="row">
            <div class="col-12  text-center">
                <div class="card">
                    <div class="card-body txtthank">
                        <h3 class="card-title"> ขอขอบคุณที่ให้ความสนใจลงทะเบียนเพื่อร่วมกิจกรรม </h3>
                        <h5>กับ Kawebook ของเรา</h5>
                        <P>ทางเราจะนำข้อมูลของท่านไปใช้ร่วมสนุกกับกิจกรรมของเรา</P>
                        <p>ขอขอบคุณผู้อ่านทุกท่านที่สนใจร่วมสนุกกับเรา</p>
                        <br>
                        <a class="btn btn-primary" href="index.php" role="button">กลับสู่หน้าหลัก</a>
                    </div>
                </div>
            </div>
        </div>
